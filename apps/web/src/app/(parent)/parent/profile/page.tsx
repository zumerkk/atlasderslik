...
import { User, Mail, Shield, Phone, Save, Loader2, CheckCircle, AlertCircle } from "lucide-react";
...
export default function ParentProfile() {
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
            <PageHeader title="Profilim" description="Hesap bilgilerinizi görüntüleyin ve düzenleyin." />
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="grid gap-2">
                            ...
                            <div><Badge variant="info">Veli</Badge></div>
                        </div>
