...
import { User, Mail, Shield, Save, Loader2, CheckCircle, AlertCircle, BookOpen, Phone } from "lucide-react";
                ...
                <Card>
                    <CardHeader>
                        <div className="flex items-center gap-3">
                            ...
                            <div><CardTitle>Kişisel Bilgiler</CardTitle><CardDescription>Hesap detaylarınızı düzenleyin.</CardDescription></div>
                        </div>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="grid gap-2">
                                <Label className="flex items-center gap-1.5"><BookOpen className="h-3.5 w-3.5" /> Sınıf</Label>
                                <div><Badge variant="secondary">{user?.gradeLevel ? `${user.gradeLevel}. Sınıf` : user?.grade ? `${user.grade}. Sınıf` : "—"}</Badge></div>
                            </div>
                        </div>
